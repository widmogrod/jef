...
var zip = require('../../src/stream/zip');
...
describe('Stream.zip', function() {
    ...
    describe('#on', function() {
        ...
        describe('synchronously', function() {
            ...
            it('should be called on every pair of events', function() {
                object.on(Stubs.onValue);
            ...
            it('should register onValue and stop', function() {
                ...
                object.args.onValue.should.be.eql([1, 'a']);
            });
        ...
        describe('asynchronously', function() {
            ...
            it('should be called on every pair of events', function(done) {
                object.on(Stubs.onValue);
